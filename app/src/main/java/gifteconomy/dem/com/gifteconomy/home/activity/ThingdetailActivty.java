 ...
 */
public class ThingdetailActivty extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userThing = (UserThing) getIntent().getExtras().getSerializable("userThing");
        Log.e("userThing", userThing.thing);
        initToolbar();
        init();
    }
    ...
    private void init() {
        ...
        llUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ThingdetailActivty.this,ProfileActivity.class);
    ...
    private void setLayoutDetail(View contentView) {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    // do action
                    Toast.makeText(ThingdetailActivty.this,"Message send successfully",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
